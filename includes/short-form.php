...
<form class="lead-short-form lead-short-form-box" action="<?php echo $root_prefix; ?>submit-booking.php" method="POST">
    ...
    <div class="sf-field">
        ...
        <textarea name="message" rows="2" placeholder="Need a maid for babysitting, cooking, cleaning, or elderly care?" style="width: 100%; padding: 6px 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 12px; outline: none; background: #fff;"></textarea>
    </div>
